  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (currentValue !== null) {
      this.total = currentValue.reduce(
        (accumulator, currentValue) => accumulator + currentValue.realIncome - currentValue.powerExpenses - currentValue.checkExpenses - currentValue.requestExpenses, this.total
      )
